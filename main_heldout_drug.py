# -*- coding: utf-8 -*-
"""
main_heldout_drug.py — giao thuc GIU LAI THEO THUOC (GroupKFold tren ma thuoc),
cot "Drug-held-out" cua Bang 2 trong bai ICTA 2026 "Dual-BERT".
Muc tieu huan luyen: MSE + ranking loss, lambda = 0.4, margin = 0.1.

    python main_heldout_drug.py
...
PREDICT_DIR = 'predictResult_heldout_drug'
# ===================================
