# -*- coding: utf-8 -*-
"""
main_clean_rank00.py — bien the CHI HOI QUY (rank_weight = 0.0) dung cho Bang 3
(nghien cuu loai bo ham mat mat xep hang) trong bai ICTA 2026 "Dual-BERT".

    python main_clean_rank00.py
...
PREDICT_DIR = 'predictResult_clean_rank00'
# ===================================
